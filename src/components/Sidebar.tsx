    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 pb-2">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-black tracking-tight text-sidebar-foreground">VetCare</h1>
          ...
          <div className="p-6 pt-2 space-y-4 bg-sidebar">
            <Separator className="bg-border/50" />
            <div className="flex items-center gap-3 px-3 py-3 rounded-2xl bg-muted/30 border border-border/50">
