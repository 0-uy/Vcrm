    ...
    try {
      ...
      if (!docSnap.exists()) {
        await setDoc(docRef, {
          ...
          role: 'admin',
          clinicId: `clinic-${Math.random().toString(36).substr(2, 9)}`,
        });
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.code === 'auth/email-already-in-use') {
        ...
        message = 'El método Email/Contraseña no está habilitado. Por favor, actívalo en la Consola de Firebase o usa Google.';
